...
import userCustomSyles from './usage.css'
...
const useClapAnimation = ({ clapEl,countEl,clapTotalEl }) => {
  ...
  useLayoutEffect(() => {
    ...
    const tlDuration = 300;
      ...
      const newAnimationTimeline = animationTimeline.add([scaleButton, circleBurst, triangleBurst, countTotalAnimation, countAnimation]);
...
const ClapCount = ({style: userStyles = {}}) => {
  ...
  return <span style={userStyles} ref={setRef} data-refkey="clapCountRef" className={styles.count}>
    + {count}
  </span>
}
...
const CountTotal = ({style: userStyles = {}}) => {
  ...
  return <span style={userStyles} ref={setRef} data-refkey="clapTotalRef" className={styles.total}>
    {countTotal}
  </span>
}
...
const Usage = () => {
  ...
  return (
    <div style={{width: '100%'}}>
      <MediumClap onClap={handleClap} className={userCustomSyles.clap}>
        <MediumClap.Icon className={userCustomSyles.icon} />
        <MediumClap.Count className={userCustomSyles.count} />
        <MediumClap.Total className={userCustomSyles.total} />
      </MediumClap>
